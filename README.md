STM32 Cube library - CMSIS and HAL for F0, F4, F7, H7, L4 and L1 microcontrollers
=================================================================================
...
STM32H7xx, STM32L4xx and STM32L1xx microcontrollers.  Minor changes are applied
to the HAL source to support MicroPython's port to the STM32.
